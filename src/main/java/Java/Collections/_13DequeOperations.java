...
public class _13DequeOperations {

	/*
	 * Deque is a Queue in which you can add and remove elements from both
	 * sides. In the Java Queue tutorial we have seen that the Queue follows
	 * FIFO (First in First out) and in PriorityQueue example we have seen how
	 * to remove and add elements based on the priority. In this tutorial, we
	 * will see how to use Deque.
	 */
