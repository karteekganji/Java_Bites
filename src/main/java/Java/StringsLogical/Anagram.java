...
public class Anagram {
    ...
    public static void main(String[] args) {
    	/*StringBuilder sbSecond = new StringBuilder("karteek");
    	System.out.println(sbSecond.indexOf("t"));*/
    	System.out.println(checkAnagram("bahubali", "alibabhu"));
